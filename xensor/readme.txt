...
That id after `post=29749` is the number you need for the page id. 
...
3. http://www.pixelmonmemories.ml/wp-content/uploads/2017/06/maint.png
== Changelog ==
...
= 1.0 =
1.Initial start of the plugin path.
1. Set up the code to allow admins to edit details for the plugin
1. Set up redirects to kick ban members to a set page and also redirect non-staff to a maintenance page when maintenance is enabled.
